...
--
-- manually_updated flag:
--   0 = owner has not customised this entry.
--       getMergedProjects() uses live GitHub API data for display.
--   1 = owner has edited this entry in the owner interface.
--       getMergedProjects() uses DB data instead of GitHub data.
--   This flag is the selector between "GitHub controls this" and
--   "owner controls this" — no data is ever lost either way.
--
-- group_id:
